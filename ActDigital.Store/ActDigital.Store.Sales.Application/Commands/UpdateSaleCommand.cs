...
public class UpdateSaleCommand : Command
{
    ...
    public UpdateSaleCommand(Guid id, int saleNumber, DateTime date, Guid customerId, string branchSaleMade, ICollection<ProductViewModel> products, decimal totalSaleAmount, bool isActive)
    {
        Id = id;
    ...
    {
        ValidationResult = new UpdateSaleValidation().Validate(this);
        return ValidationResult.IsValid;
    }
}

public class UpdateSaleValidation : AbstractValidator<UpdateSaleCommand>
{
    public UpdateSaleValidation()
    {
        RuleFor(c => c.Id)
            .NotNull()
